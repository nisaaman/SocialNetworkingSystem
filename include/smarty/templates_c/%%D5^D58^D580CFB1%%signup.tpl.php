<?php /* Smarty version 2.6.14, created on 2013-02-19 09:12:11
         compiled from signup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lower', 'signup.tpl', 305, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['step'] == 4): ?>
  ...
  <br><br>
  <?php if ($this->_tpl_vars['setting']['setting_signup_verify'] == 0 && $this->_tpl_vars['setting']['setting_signup_randpass'] == 0): ?>
...
')"; onMouseout="hidetip()">
  ...
  <td class='form2'>
    ...
    <option value='6'<?php if ($this->_tpl_vars['signup_timezone'] == '6'): ?> SELECTED<?php endif; ?>>Astana, Dhaka</option>
