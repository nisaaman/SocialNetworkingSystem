...
smarty_core_load_plugins(array('plugins' => array(array('function', 'array', 'header.tpl', 15, false),)), $this); ?>
<html>
<head>
...
<a href='user_home.php' class='top_menu_item'><?php echo $this->_tpl_vars['user']->user_info['user_username']; ?>
    ...
    <?php else: ?>
  <b> <a href='home.php' class='top_menu_item'><?php echo $this->_tpl_vars['header3']; ?>
</a>&nbsp;&nbsp;&nbsp;
  <?php endif; ?>
</td>
...
' class='menu_item'><img src='./images/icons/menu_profile.gif' border='0' class='icon'><?php echo $this->_tpl_vars['header12']; ?>
	   ...
	   <td class='menu_item'>
       <img src='./images/icons/menu_editprofile.gif' border='0' class='icon'><a href='user_editprofile.php'><?php echo $this->_tpl_vars['header13']; ?>
</a>
    </td>
...
' class='menu_item'>
		  <img src='./images/icons/<?php echo $this->_tpl_vars['global_plugin_menu'][$this->_sections['menu_loop']['index']]['1']; ?>
' border='0' class='icon'  ><?php echo $this->_tpl_vars['global_plugin_menu'][$this->_sections['menu_loop']['index']]['2']; ?>
    ...
    <?php endfor; endif; ?> 
      ...
      <td class='menu_item'>
        <a href='user_messages.php' class='menu_item'><img src='./images/icons/menu_messages.gif' border='0' class='icon'><?php echo $this->_tpl_vars['header18']; ?>

		<?php if ($this->_tpl_vars['user_unread_pms'] != 0): ?> (<?php echo $this->_tpl_vars['user_unread_pms']; ?>
)<?php endif; ?></a>
      </td>
    <?php endif; ?>
	        <td class='menu_item'>
      <a href='user_account_pass.php' class='menu_item'><img src='./images/icons/menu_account.gif' border='0' class='icon'><?php echo $this->_tpl_vars['header19']; ?>
</a>
    </td>
