...
<td style='padding-right: 10px;'>
  <table cellpadding='0' cellspacing='0'>
  <tr><td class='button' nowrap='nowrap'><img src='./images/icons/album_back16.gif' border='0' class='icon'><a href='user_album_update.php?album_id={$album_id}'>{$user_album_comments6}</a></td></tr>
  </table>
</td>
</tr>
</table>
